...
<html lang="es">
  <head>
    <meta charset="utf-8"><!--compatibildad de edge-->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1"><!--compatibilidad responsive-->
    ...
    <section class="login-content">
      ...
      <div id="divLoading" >
        ...
        <h3 class="login-head"><i class="fas fa-key"></i> Cambiar Contraseña</h3>
          ...
          <div class="form-group">
            <input id="txtPasswordConfirm" name="txtPasswordConfirm" class="form-control" type="password" placeholder="Confirmar Contraceña" required>
          </div>
